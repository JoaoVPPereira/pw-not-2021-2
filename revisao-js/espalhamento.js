//let minimo = Math.min(15, 7, 23, 2, 30, 21, 14) // Joga o menor número da lista na variável minimo
...
// Usando o operador de espalhamento para converter um vetor em uma série de valores "soltos". representado pelos 3 pontos.
...
//let carro2 = carro // Não gera uma cópia objeto, apenas uma nova referência.

// Gerando uma cópia real de um objeto usando espalhamento
let carro2 = {...carro}
...
let soma1 = somaTudo(14, 35, 10, 19, 41, 11)
let soma2 = somaTudo(4, 12, 18, 9, 3)

// Caso especial da sintaxe de espalhamento: parâmetro de resto
// O nome de um parâmetro precedido por ... receberá todos os argumentos passados e se comportará como um vetor
