...
// - Não são necessários os parênteses em torno do argumento
// - Depois do argumento vem =>
// - Não são necessárias as chaves e nem a palavra return
...
// Função tradicional com várias linhas no corpo
function fatorial(n) {
    let fat = 1
