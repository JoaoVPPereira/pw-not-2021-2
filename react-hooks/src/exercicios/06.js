...
function PokemonInfo({pokemonName}) {
    ...
    React.useEffect(() => {
        ...
        // Isso irá chamar a API no servidor remoto, que se tudo der certo, enviará os dados do pokemon informado
        // Esse acesso a API reomota pode demorar algum tempo. Quando o servidor remoto finalmente responde (com dados ou com erro),
        // é executada a função dentro do then(). Essa função recebe os dados enviados pela API e os coloca dentro da variável de estado "pokemon".
    ...
    // A variável de estado "pokemon" está vazia; a chamada à API falhou e então mostramos uma informação genérica(fallback)
